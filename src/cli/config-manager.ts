...
export function writeOmoConfig(installConfig: InstallConfig): ConfigMergeResult {
  ...
  try {
    ...
    return { success: false, configPath: omoConfigPath, error: formatErrorWithSuggestion(err, "write fuyao-opencode config") }
  }
}
...
export function detectCurrentConfig(): DetectedConfig {
  ...
  result.isInstalled = plugins.some((p) => p.startsWith("fuyao-opencode"))
